                            ...
                            <tbody>
                                <c:forEach items="${managerList}" var="manager">
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="hidden-480">${manager.managerName}</td>
                                        <td class="hidden-480">${manager.collegeName}</td>
                                        <td class="hidden-480">
                                            <a href="javascript:if(confirm('确认重置密码吗?'))window.location='/admin/resetManager2Password?managerName=${manager.managerName}'" class="btn mini red" target="rightFrame">
