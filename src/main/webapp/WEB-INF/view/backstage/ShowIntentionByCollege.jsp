    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    <h3 class="page-title">
                        志愿意向信息：&nbsp;&nbsp;<input name="teacherId" id="teacherId" value="" type="text">
                    </h3>
                    <ul class="breadcrumb">
                        <li>
                            <i class="icon-home"></i>
                                        ...
                                        <td class="hidden-480">
                                            <select style="width: 130px;height: 34px" name="selectTeacher"
                                                ...
                                                <option value="${intention.teacher.get(2).getTeacherId()}" style="color:#999999">
                                                    ...
                                                    <%--</c:forEach>--%>
                                                <option value="" style="color:#999999">调剂</option>
                                            </select>
                                        </td>

                                        <td class="hidden-480" >

                                            <a href="javascript:if(confirm('确定分配该志愿吗?'))  {window.location='/admin/volunteerRecognition?studentId=${intention.studentId}&selectTeacher='+document.getElementById('selectTeacher').value;}"
